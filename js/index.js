...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const colorLinks = document.querySelectorAll('.color-selector .colors ul li a');
    console.log(colorLinks);

    colorLinks.forEach(link => {
        link.addEventListener('click', function(event) {
            event.preventDefault();
            console.log('Color link clicked:', this);
            ...
            // Change the background color of the page (or another element)
